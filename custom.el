(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-grammarly pylint poetry ob-julia-vterm ob-ess-julia lsp-ui lsp-pyright lsp-julia julia-snail julia-repl julia-formatter fortpy flycheck-julia blacken)))
(custom-set-faces
