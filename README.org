...
;; (add-hook 'window-setup-hook #'treemacs-select-window 'append)
#+end_src
...
#+end_src
**** iSort
Automatically reorder imports on save
...
(use-package! lsp-pyright
  ...
  (lsp-pyright-log-level "Information")
...
;; (lsp-register-client
;;     (make-lsp-client
;;         :new-connection (lsp-tramp-connection (lambda () (list lsp-ruff-executable)))
